...
<footer class="site-footer">
			...
			<div class="site-footer__grid">
				...
				<div class="site-footer__brand">
					...
					<div class="site-footer__social">
						<a href="https://linkedin.com/company/leap-distributors" class="social-link" aria-label="LinkedIn" target="_blank" rel="noopener">
	...
	<div class="site-footer__bottom">
		<div class="container">
			...
			<span class="site-footer__copy" style="font-style:italic;opacity:0.5;">Better. Together.</span>
		</div>
	</div>
</footer>
...
<div id="leap-chat" class="lc" aria-live="polite" aria-label="Leap AI Assistant">
	...
	<div class="lc__panel" id="lc-panel" aria-hidden="true">
		...
		<form class="lc__form" id="lc-form" autocomplete="off">
			<input class="lc__input" id="lc-input" type="text" placeholder="Ask something…" aria-label="Message" maxlength="500" required>

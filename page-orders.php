	...
	<div class="container container--narrow">
		<div style="display:grid;grid-template-columns:repeat(2,1fr);gap:var(--space-6);margin-bottom:var(--space-12);" data-stagger>
			<div class="card reveal" data-stagger-child data-glow style="text-align:center;padding:var(--space-10);">
				...
				<p style="color:var(--color-text-3);font-weight:300;margin-bottom:var(--space-6);font-size:var(--text-sm);">Submit a new product order through our team or ordering portal.</p>
			...
			<div class="card reveal" data-stagger-child data-glow style="text-align:center;padding:var(--space-10);">
				...
				<p style="color:var(--color-text-3);font-weight:300;margin-bottom:var(--space-6);font-size:var(--text-sm);">Check the status and location of your current deliveries.</p>
		...
		<div class="card reveal" data-glow style="padding:var(--space-10);text-align:center;">
			...
			<p style="color:var(--color-text-3);font-weight:300;margin-bottom:var(--space-8);">Our client support team is available to assist with orders, returns, billing, and product questions.</p>
			<div style="display:flex;justify-content:center;flex-wrap:wrap;gap:var(--space-4);">
				...
				<a href="mailto:info@leapdistributors.com" class="btn btn--outline">Email Support</a>
			</div>
		</div>
	</div>
</section>

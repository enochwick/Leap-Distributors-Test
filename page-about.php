...
<section class="content-section">
	<div class="container">
		<div class="leap-intro reveal">
			<div>
				<h2 class="leap-intro__h">Two hubs. One mission.</h2>
			</div>
			<div class="leap-intro__body">
				<p>Leap operates out of Dallas and Houston, with internal teams across the south central US and a distributor partner network that reaches the rest of the country. We came together from Leap Surgical and DUB Enterprises with a single goal: build a distribution company that surgeons, hospitals, and manufacturers could actually count on.</p>
			</div>
		</div>
...
<section class="content-section">
	<div class="container">
		<div class="leap-intro reveal">
			<div>
				<h2 class="leap-intro__h">Meet the Partners.</h2>
			</div>
			<div class="leap-intro__body">
				<p>Four founders. 75+ years in medical device distribution.</p>
			</div>
		</div>
